...
export default function Menu(props) {
  ...
  return (
    <div>
      {props.trigger === 'icon' ? (
        <IconButton aria-label={props.label} aria-haspopup="true" onClick={handleClick} color={props.color}>
          <Icon>{props.icon}</Icon>
        </IconButton>
      ) : (
        <Button aria-haspopup="true" variant={props.buttonVariant} color={props.color} onClick={handleClick}>
          {props.label}
        </Button>
      )}
